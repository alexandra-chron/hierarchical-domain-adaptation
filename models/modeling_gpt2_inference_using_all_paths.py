    ...
    def forward(
        ...
        if self.use_adapters:
            if self.use_tree_structure:
                ...
                adapters_active = 3
                if path == 0:
                    adapter_outputs = self.adapter_module[0](feed_forward_hidden_states) +\
                                      self.adapter_module[4](feed_forward_hidden_states)\
                                      + self.adapter_module[6](feed_forward_hidden_states)
                elif path == 1:
                    adapter_outputs = self.adapter_module[1](feed_forward_hidden_states) +\
                                      self.adapter_module[4](feed_forward_hidden_states)\
                                      + self.adapter_module[6](feed_forward_hidden_states)
                elif path == 2:
                    adapter_outputs = self.adapter_module[2](feed_forward_hidden_states) +\
                                      self.adapter_module[5](feed_forward_hidden_states)\
                                      + self.adapter_module[6](feed_forward_hidden_states)
                elif path == 3:
                    adapter_outputs = self.adapter_module[3](feed_forward_hidden_states) +\
                                      self.adapter_module[5](feed_forward_hidden_states)\
                                      + self.adapter_module[6](feed_forward_hidden_states)

                # self.adapter_module[0](feed_forward_hidden_states) -> frontiers
                # self.adapter_module[1](feed_forward_hidden_states) -> journals
                # self.adapter_module[2](feed_forward_hidden_states) -> nytimes
                # self.adapter_module[3](feed_forward_hidden_states) -> latimes
                # self.adapter_module[4](feed_forward_hidden_states) -> parent of (front,journ)
                # self.adapter_module[5](feed_forward_hidden_states) -> parent of (ny,la)
                # self.adapter_module[6](feed_forward_hidden_states) -> grandparent
