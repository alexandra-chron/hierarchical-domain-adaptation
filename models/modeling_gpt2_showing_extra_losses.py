        ...
        if self.use_adapters:
            if self.use_tree_structure:
                ...
                while ind != 0:  # while we haven't found the root of the tree
                    ...
                    adapter_outputs_list.append(self.adapter_module[ind-1](feed_forward_hidden_states))
                    # print("\n" + str(ind))
                ...
                if not alt:
                    ...
                    if eval == "leaf":
                        feed_forward_hidden_states = adapter_outputs_list[0]
                    elif eval == "parent":
                        feed_forward_hidden_states = adapter_outputs_list[1]
                    elif eval == "grandparent":
                        feed_forward_hidden_states = adapter_outputs_list[2]
...
class GPT2LMHeadModel(GPT2PreTrainedModel):
    ...
    def forward(
        ...
        transformer_outputs = self.transformer(
            ...
            dataset_ind=dataset_ind,alt=alt, eval=eval
        )
