    ...
    def forward(
        ...
        if self.use_adapters:
            if self.use_tree_structure:
                ...
                rest_of_adapter_outputs = 0
                for i in range(1, adapters_active):
                    rest_of_adapter_outputs += adapter_outputs[i]
                average_of_rest = rest_of_adapter_outputs / (adapters_active - 1)

                feed_forward_hidden_states = leaf_adapter_output * 0.6 + average_of_rest * 0.4
